...
const features = [
  {
    ...
    description: "Deep dive into your Kundli to understand your inherent strengths and life purpose."
  },
  {
    icon: <Moon className="h-8 w-8 text-secondary" />,
    title: "Dasha & Transit",
    description: "Navigate current planetary cycles and prepare for upcoming life transitions."
  },
  {
    icon: <Compass className="h-8 w-8 text-accent" />,
    title: "Career & Wealth",
    description: "Align your professional path with your cosmic design for abundance and fulfillment."
  }
];
  ...
  return (
    <div className="relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-serif mb-8 leading-[1.1] text-secondary">
                Unlock Your <span className="text-primary italic">Cosmic Blueprint</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-xl">
                Discover the profound insights of Vedic Astrology with Dr. Sekar Chivukula, PhD. 
                Navigate your life's journey with clarity, purpose, and spiritual alignment.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Button nativeButton={false} render={<Link to="/booking" />} size="lg" className="bg-primary hover:bg-primary/90 text-lg px-8 h-14 rounded-full">
                  Book a Consultation
                </Button>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10 rounded-3xl overflow-hidden p-2 bg-transparent">
                <div className="relative">
                  <img 
                    src="https://picsum.photos/seed/sekar-headshot/600/700" 
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif mb-4">Our Sacred Offerings</h2>
              ...
              >
                <Card className="h-full hover:shadow-2xl transition-all duration-500 border-none bg-background/50 group overflow-hidden">
                  <CardContent className="p-8 relative">
                    ...
                    <h3 className="text-2xl font-serif mb-4 text-secondary">{feature.title}</h3>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      {feature.description}
                    </p>
                    <Link to="/booking" className="inline-flex items-center gap-2 text-primary font-medium hover:gap-4 transition-all">
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif mb-4">Voices of the Soul</h2>
            <p className="text-muted-foreground">What our community says about their journey with Sekar</p>
            ...
            {[
              {
                name: "Sarah Jenkins",
                role: "Entrepreneur",
                content: "The 30-minute session was incredibly dense with insight. Dr. Sekar pinpointed my career challenges with frightening accuracy.",
                rating: 5
              },
              {
                name: "Rajesh Kumar",
                role: "Software Engineer",
                content: "I've been following Dr. Sekar on YouTube for years, but a personal reading changed everything. Highly recommended for clarity.",
                rating: 5
              },
              {
                name: "Elena Rodriguez",
                role: "Artist",
                content: "Vedic astrology felt intimidating until I met Dr. Sekar. He explains things with such warmth and modern context.",
                rating: 5
              }
            ].map((review, index) => (
              <motion.div
              ...
              >
                <Card className="h-full border-none shadow-md hover:shadow-xl transition-all p-8 bg-white">
                  ...
                  <p className="text-secondary/80 italic mb-6 leading-relaxed">"{review.content}"</p>
                  <div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <blockquote className="text-3xl md:text-5xl font-serif italic leading-tight mb-12">
              "The stars do not compel us, they incline us. Understanding your cosmic design is the first step toward true freedom."
            </blockquote>
            <cite className="text-xl font-medium text-primary not-italic">— Dr. Sekar Chivukula, PhD</cite>
          </motion.div>
        </div>
      </section>
    </div>
