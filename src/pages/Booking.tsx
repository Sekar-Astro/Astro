        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <Card className="border-none shadow-2xl overflow-hidden bg-white min-h-[850px] lg:min-h-[900px]">
                <CardContent className="p-0 h-full min-h-[850px]">
                  <iframe 
                    ...
                    style={{ border: 0, minHeight: '850px' }} 
                    width="100%" 
                    height="100%" 
                    frameBorder="0"
